    ...
    <div class="page page-center">
      <div class="container container-tight py-4">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              <label class="form-check">
                ...
                <span class="form-check-label">Agree the <a href="terminos" target="_blank" tabindex="-1">Terminos y condiciones</a>.</span>
              </label>
            </div>
        ...
        <div class="text-center text-secondary mt-3">
          Ya tienes cuenta ? <a href="/" tabindex="-1">Entrar</a>
        </div>
      </div>
    </div>
    <!-- Libs JS -->
